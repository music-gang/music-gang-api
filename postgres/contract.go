...
func (cs *ContractService) MakeRevision(ctx context.Context, id int64, revision *entity.Revision) error

// UpdateContract updates the given contract.
// Return ENOTFOUND if the contract does not exist.
// Return EUNAUTHORIZED if the contract is not owned by the authenticated user.
func (cs *ContractService) UpdateContract(ctx context.Context, id int64, contract service.ContractUpdate) (*entity.Contract, error)
